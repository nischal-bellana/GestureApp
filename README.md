...
Run the desktop application to manage your gestures and train your models:
...
**Record Static Gestures:** Click Step 1 in the UI to open the webcam. Press t to toggle through your gestures and record baseline shape data.

**Train Static Model:** Click Step 2 to instantly train the Random Forest gatekeeper model.

**Record & Train Dynamic Gestures:** Use Step 3 and Step 4 to record your movement variances and train the sequence model.
